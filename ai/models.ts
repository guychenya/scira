...
export const PROVIDERS: Record<ModelProvider, ProviderInfo> = {
  ...
  ollama: { id: 'ollama', name: 'Ollama (Local)', icon: 'ollama', hasNew: true },
};
...
export const models: Model[] = [
  ...
  // Models (Ollama - local, self-hosted on 192.168.1.183)
  {
    value: 'scira-ollama-qwen3-coder',
    label: 'Qwen3 Coder 30B (Local)',
    description: 'Self-hosted local coding model via Ollama — no cloud, no API key',
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-qwen3-1.7b',
    label: 'Qwen3 1.7B (Local)',
    description: 'Self-hosted small fast local model via Ollama — no cloud, no API key',
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-glm-4.7-flash',
    label: 'GLM 4.7 Flash 30B (Local)',
    description: 'Self-hosted local reasoning model via Ollama — no cloud, no API key',
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-dictalm-12b',
    label: 'DictaLM 12B (Local)',
    description: 'Self-hosted local Hebrew-focused model via Ollama — no cloud, no API key',
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-aya-expanse-32b',
    label: 'Aya Expanse 32B (Local)',
    description: 'Self-hosted local multilingual model via Ollama — no cloud, no API key',
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-aya-expanse-8b',
    label: 'Aya Expanse 8B (Local)',
    description: 'Self-hosted small local multilingual model via Ollama — no cloud, no API key',
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-qwen2.5vl-7b',
    label: 'Qwen2.5 VL 7B (Local)',
    description: 'Self-hosted local vision model via Ollama — no cloud, no API key',
    vision: true,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-devstral-small-2',
    label: 'Devstral Small 2 24B (Local)',
    description: 'Self-hosted local coding + vision model via Ollama — no cloud, no API key',
    vision: true,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-llama3.3',
    label: 'Llama 3.3 70B (Local)',
    description: 'Self-hosted large general-purpose model via Ollama — no cloud, no API key',
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-qwen3.6-27b',
    label: 'Qwen3.6 27B (Local)',
    description: 'Self-hosted local vision + reasoning model via Ollama — no cloud, no API key',
    vision: true,
    reasoning: true,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-ollama-llama3.2-3b',
    label: 'Llama 3.2 3B (Local)',
    description: 'Self-hosted small fast local model via Ollama on 192.168.1.178 — no cloud, no API key',
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
